...
| `bronze_energia.demanda_raw` (ensayo clase 3, `workspace.c01_<usuario>`) | Mismas dos funciones con `current_user()` en lugar del grupo | El owner del esquema | Cualquier otro usuario del workspace |
